        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sidenav">
            <div id="registration">
                <div id="userDiv">
                    ...
                    <input disabled id="userName" type="text" name="userName" class="form-text" placeholder="WeLoveRaccoonCity" value="<?php echo $userName;?>"/><br/>
                </div>
                <div id="passDiv">
                    <label for="PASSWORD" class="identify-text">Password: *</label><br/>
                    <input disabled id="PASSWORD" type="PASSWORD" name="PASSWORD" class="form-text" placeholder="ABC123$d" value="<?php echo $PASSWORD;?>"/><br/>
                </div>
                <div id="verPassDiv">
                    <label for="repeatPassword" class="identify-text">Repeat Password:  *</label><br/>
                    <input disabled id="repeatPassword" type="password" name="repeatPassword" class="form-text" placeholder="ABC123$d" value="<?php echo $repeatPassword;?>"/><br/>
                </div>
                <div id ="firstDiv">
                    <label for="firstName" class="identify-text">First Name:  *</label><br/>
                    <input disabled id="firstName" type="text" name="firstName" class="form-text" placeholder="Leon" value="<?php echo $firstName;?>"/><br/>
                </div>
                <div id="lastDiv">
                    <label for="lastName" class="identify-text">Last Name:  *</label><br/>
                    <input disabled id="lastName" type="text" name="lastName" class="form-text" placeholder="Kennedy" value="<?php echo $lastName;?>"/><br/>
                </div>
                <div id="add1Div">
                    <label for="address1" class="identify-text">Address Line 1:  *</label><br/>
                    <input disabled id="address1" type="text" name="address1" class="form-text" placeholder="123 Arklay Drive" value="<?php echo $address1;?>"/><br/>
                </div>
                <div id="add2Div">
                    <label for="address2" class="identify-text">Address Line 2:</label><br/>
                    <input disabled id="address2" type="text" name="address2" class="form-text" placeholder="(Optional)" value="<?php echo $address2;?>"/><br/>
                </div>
                <div id="cityDiv">
                    <label for="city" class="identify-text">City:  *</label><br/>
                    <input disabled id="city" type="text" name="city" class="form-text" placeholder="Raccoon City" value="<?php echo $city;?>"/><br/>
                </div>
                <div id="stateDiv">
                ...
                <div id="zipDiv">
                    ...
                    <input disabled id="zip" type="text" name="zip" class="form-text" placeholder="73110" value="<?php echo $zip;?>"/><br/>
                </div>
                <div id="phoneDiv">
                    <label for="phone" class="identify-text">Phone Number:  *</label><br/>
                    <input disabled id="phone" type="text" name="phone" class="form-text" placeholder="314-955-3233" value="<?php echo $phone;?>"/><br/>
                </div>
                <div id="emailDiv">
                    <label for="email" class="identify-text">Email:  *</label><br/>
                    <input disabled id="email" type="text" name="email" class="form-text" placeholder="KennedyLeon@gmail.com" value="<?php echo $email;?>"/><br/>
                </div>
                <div id="genderDiv">
                    <label for="male" id="gender">Gender:  *</label><br/>
                    <input disabled type="radio" name="gender" id="male" value="male" <?php if ($gender=="male") {echo "checked";}?>/><label for="male">Male</label>
                    <input disabled type="radio" name="gender" id="female" value="female" <?php if ($gender=="female") {echo "checked";}?>/><label for="female">Female</label><br/>
                    <input disabled type="radio" name="gender" id="other" value="other" <?php if ($gender=="other") {echo "checked";}?>/><label for="other">Other</label><br/>
                </div>
                <div id="maritalDiv">
                    <label for="single" id="marital">Martial Status:  *</label><br/>
                    <input disabled type="radio" name="marital" id="single" value="single" <?php if ($marital=="single") {echo "checked";}?>/><label for="single">Single</label>
                    <input disabled type="radio" name="marital" id="married" value="married" <?php if ($marital=="married") {echo "checked";}?>/><label for="married">Married</label><br/>
                    <input disabled type="radio" name="marital" id="widowed" value="widowed" <?php if ($marital=="widowed") {echo "checked";}?>/><label for="widowed">Widowed</label>
                    <input disabled type="radio" name="marital" id="divorced" value="divorced" <?php if ($marital=="divorced") {echo "checked";}?>/><label for="divorced">Divorced</label><br/>
                </div>
                <div id="birthDiv">
